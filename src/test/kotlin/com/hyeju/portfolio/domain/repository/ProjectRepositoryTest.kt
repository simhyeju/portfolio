...
class ProjectRepositoryTest(
    ...
    fun testFindAll(){
        ...
        for(project in projects){
            ...
            println("project.detatils.size: ${project.details.size}")

            assertThat(project.skills).hasSize(project.name.toInt())
            println("project.detatils.size: ${project.skills.size}")
        }
    ...
    fun testFindAllByIsActive() {
        println("------testFindByIsActive 테스트 시작-------")
        ...
        println("------testFindByIsActive 테스트 종료-------")
    }
