package com.hyeju.portfolio.domain

import com.hyeju.portfolio.domain.constant.SkillType
import com.hyeju.portfolio.domain.entitiy.*
import com.hyeju.portfolio.domain.repository.*
...
class DataInitializer(
    ...
    fun initializeData(){
        ...
        println("스프링이 실행되었습니다. 테스트 데이터를 초기화를 합니다.")

        val achievements = mutableListOf<Achievement>(
                Achievement(
                        title = "2022 DDDD",
                        description = "dddfdffffddddddddd",
                        host = "dkddk",
                        achievedDate = LocalDate.of(2022,8,22),
                        isActive = true
                ),
                Achievement(
                    title = "정보처리기사",
                    ...
                    host = "한국산업인력공단",
                    achievedDate = LocalDate.of(2020,2,22),
                    isActive = true
                )
        )
        ...
        val links = mutableListOf<Link>(
            Link(name = "Github", content = "http://github.com/infomuscle", isActive = true),
        ...
        val project1 = Project(
            ...
            description = "유기묘 위치의 실시간 공유, 임시보호까지 연결해주는 서비스. 구글 맵스를 연동하여 유기묘 위치 정보를 알수 있다",
            startYear = 2022,
            startMonth = 9,
            endYear = 2022,
            endMonth = 12,
